...
class ViteService
{
    ...
    public function __construct(
        ...
        if ($this->theme !== null) {
            $this->buildDirectory = $buildDirectory . '/' . $this->theme;
        }
...
<<<<<<< HEAD
    ...
    public function setTheme(?string $theme): self
    {
        ...
        if ($this->theme !== null) {
            $originalBuildDir = explode('/', $this->buildDirectory)[0];
            $this->buildDirectory = $originalBuildDir . '/' . $this->theme;
        }
     ...
     *
     * @return string|null Current theme
     */
